...
$config['tables']['roles_groups']  	 = 'roles_groups';
 ...
 */
$config['site_title']                 = "Sistema de Vales";       // Site Title, example.com
$config['admin_email']                = "lfradusco@ilva.com.ar"; // Admin Email, admin@example.com
$config['default_group']              = 'Requeridor';           // Default group, use name

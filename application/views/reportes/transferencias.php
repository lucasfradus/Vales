    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Generar Nuevo Reporte de Transferencias</h3>
            </div>
            <div class"box-body">
                <div class="col-md-12">
                ...
                if(result){
                    response = $.parseJSON(result);
                                    ...
                                    $.each(response, function(i, item) {
                                        var newRowContent = '<tr><td>'+item.num_art+'</td><td>'+item.unidad+'</td><td>'+item.descr+'</td><td>'+item.cant+'</td><td></td><td></td></tr>';
                                    ...
                                    $("#tablareporte").tableExport({
                                        ...
                                        filename: 'Transferencias-'+start.format('YYYY-MM-DD')+'-'+end.format('YYYY-MM-DD'),
                                        bootstrap: true,
                                        exportButtons: true,
                                    });
                }else{
